...
public class ReportsPanel extends JPanel {
    ...
    public ReportsPanel(Sistema sistema, ProdutoManager produtoManager) {
        ...
        String[] reportTypes = { "Relatorio de Estoque Baixo", "Relatório de Vendas", "Produtos Mais Vendidos",
    ...
    private void displaySelectedReport(String reportType) {
        ...
        switch (reportType) {
            ...
            case "Análise de Lucratividade":
                ProfitabilityAnalysisPanel profitabilityAnalysisPanel = new ProfitabilityAnalysisPanel(produtoManager);
                profitabilityAnalysisPanel.setBounds(0, 0, reportDisplayPanel.getWidth(),
                        reportDisplayPanel.getHeight());
            ...
            case "Relatorio de Estoque Baixo":
                LowStockReportPanel lowStockReportPanel = new LowStockReportPanel(produtoManager);
